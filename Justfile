...
doctor:
    @echo "Running diagnostics for wokelangiser..."
...
heal:
    @echo "Attempting auto-repair for wokelangiser..."
...
help-me:
    @echo "=== wokelangiser Help ==="
    @echo "Platform: $(uname -s) $(uname -m)"
    @echo "Shell: $SHELL"
    @echo ""
    @echo "To report an issue:"
    @echo "  https://github.com/hyperpolymath/wokelangiser/issues/new"
    @echo ""
